...
/**
 * Screen for Item→Chemical custom machines.
 * <p>
 * Mirrors {@link mekanism.client.gui.machine.GuiChemicalOxidizer} but bound to
 * our {@link GenericItemToChemicalTile}.
 */
public class GenericItemToChemicalScreen extends GuiConfigurableTile<GenericItemToChemicalTile, MekanismTileContainer<GenericItemToChemicalTile>> {

    private GuiElement energyBar;

    public GenericItemToChemicalScreen(MekanismTileContainer<GenericItemToChemicalTile> container, Inventory inv, Component title) {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiChemicalGauge(() -> tile.chemicalTank, () -> tile.getChemicalTanks(null), GaugeType.STANDARD, this, 131, 13))
