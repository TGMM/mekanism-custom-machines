...
/**
 * Screen for Chemical→Chemical custom machines.
 * <p>
 * Mirrors {@link mekanism.client.gui.machine.GuiIsotopicCentrifuge} but bound
 * to our {@link GenericChemicalToChemicalTile}.
 */
public class GenericChemicalToChemicalScreen extends GuiConfigurableTile<GenericChemicalToChemicalTile, MekanismTileContainer<GenericChemicalToChemicalTile>> {

    private GuiElement energyBar;

    public GenericChemicalToChemicalScreen(MekanismTileContainer<GenericChemicalToChemicalTile> container, Inventory inv, Component title) {
