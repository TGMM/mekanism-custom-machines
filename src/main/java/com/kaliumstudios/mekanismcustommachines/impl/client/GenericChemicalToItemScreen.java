...
/**
 * Screen for Chemical→Item custom machines.
 * <p>
 * Mirrors {@link mekanism.client.gui.machine.GuiChemicalCrystallizer} but
 * bound to our {@link GenericChemicalToItemTile}.
 */
public class GenericChemicalToItemScreen extends GuiConfigurableTile<GenericChemicalToItemTile, MekanismTileContainer<GenericChemicalToItemTile>> {

    private final IOreInfo oreInfo = new OreInfo();
    private GuiElement inputGauge;

    public GenericChemicalToItemScreen(MekanismTileContainer<GenericChemicalToItemTile> container, Inventory inv, Component title) {
