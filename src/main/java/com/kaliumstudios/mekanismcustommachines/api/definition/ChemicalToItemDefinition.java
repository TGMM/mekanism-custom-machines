...
/**
 * Definition for a chemical-to-item machine (single chemical input, single
 * item output — analogous to the Chemical Crystallizer).
 */
public record ChemicalToItemDefinition(
        ResourceLocation id,
        String processName,
    ...
    public ChemicalToItemDefinition {
    ...
    public static final class Builder {
        ...
        private SoundEventRegistryObject<SoundEvent> sound = MekanismSounds.CHEMICAL_CRYSTALLIZER;
        private RecipeViewerLayout viewerLayout = RecipeViewerLayout.CRYSTALLIZER;
        ...
        public ChemicalToItemDefinition build() {
            return new ChemicalToItemDefinition(id, processName, energy, baseTicksRequired, maxChemical, sound, viewerLayout);
        }
    }
}
