...
/**
 * Definition for an item-to-chemical machine (single item input, single
 * chemical output — analogous to the Chemical Oxidizer or Pigment Extractor).
 */
public record ItemToChemicalDefinition(
        ResourceLocation id,
        String processName,
    ...
    public ItemToChemicalDefinition {
    ...
    public static final class Builder {
        ...
        private int baseTicksRequired = 100;
        private long maxChemical = 10L * FluidType.BUCKET_VOLUME;
        private SoundEventRegistryObject<SoundEvent> sound = MekanismSounds.CHEMICAL_OXIDIZER;
        private RecipeViewerLayout viewerLayout = RecipeViewerLayout.CHEMICAL_OUT;
        ...
        public ItemToChemicalDefinition build() {
            return new ItemToChemicalDefinition(id, processName, energy, baseTicksRequired, maxChemical, sound, viewerLayout);
        }
    }
}
