...
@Mod(value = MekanismCustomMachines.MODID, dist = Dist.CLIENT)
// You can use EventBusSubscriber to automatically register all static methods
// in the class annotated with @SubscribeEvent
@EventBusSubscriber(modid = MekanismCustomMachines.MODID, value = Dist.CLIENT)
public class MekanismCustomMachinesClient {
    ...
    static void onClientSetup(FMLClientSetupEvent event) {
        ...
        MekanismCustomMachines.LOGGER.info("HELLO FROM CLIENT SETUP");
        MekanismCustomMachines.LOGGER.info("MINECRAFT NAME >> {}", Minecraft.getInstance().getUser().getName());
    }
}
